...
module.exports = function() {
  ...
  if (typeof car1 !== 'undefined' && typeof car2 !== 'undefined' 
  && typeof car3 !== 'undefined' && typeof car4 !== 'undefined' 
  && typeof user1 !== 'undefined') {
    Booking.findOne({ car: car1._id }, (error, bookingType) => {
      if (!bookingType) {
    ...
    Booking.findOne({ car: car2._id }, (error, bookingType) => {
      if (!bookingType) {
    ...
    Booking.findOne({ car: car3._id }, (error, bookingType) => {
      if (!bookingType) {
    ...
    Booking.findOne({ car: car4._id }, (error, bookingType) => {
      if (!bookingType) {
