...
export class App extends Component {
  ...
  render() {
    ...
    return (
      ...
      <p className="c1 c3"><span className="c0" /></p>
      <p className="c1"><span className="c5">PAYMENT</span></p>
      ...
      <p className="c1 c3"><span className="c0" /></p>
      <p className="c1"><span className="c5">TERMINATION</span></p>
      ...
      <p className="c1 c3"><span className="c0" /></p>
      <p className="c1 c3"><span className="c0" /></p>
      <p className="c1"><span className="c5">PROPERTY IN VEHICLE</span></p>
      ...
      <p className="c1 c3"><span className="c0" /></p>
      <p className="c1"><span className="c5">PERSONAL PROPERTY SECURITIES LAW</span></p>
